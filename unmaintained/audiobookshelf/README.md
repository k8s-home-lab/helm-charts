...
![Version: 2.0.1](https://img.shields.io/badge/Version-2.0.1-informational?style=flat-square) ![AppVersion: 2.32.1](https://img.shields.io/badge/AppVersion-2.32.1-informational?style=flat-square)
...
|------------|------|---------|
| https://library-charts.k8s-at-home.com | common | 4.5.3 |
...
helm repo update
helm install audiobookshelf k8s-home-lab/audiobookshelf
```
...
helm install audiobookshelf \
  --set env.TZ="America/New York" \
    k8s-home-lab/audiobookshelf
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install audiobookshelf k8s-home-lab/audiobookshelf -f values.yaml
```
