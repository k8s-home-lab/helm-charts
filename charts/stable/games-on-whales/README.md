...
It does not require any custom settings but if you use [intel-gpu-plugin](https://github.com/Aste88/helm-charts/tree/master/charts/stable/intel-gpu-plugin)
