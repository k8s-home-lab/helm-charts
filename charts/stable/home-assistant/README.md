...
![Version: 14.0.0](https://img.shields.io/badge/Version-14.0.0-informational?style=flat-square) ![AppVersion: 2023.6.1](https://img.shields.io/badge/AppVersion-2023.6.1-informational?style=flat-square)
...
```console
helm install home-assistant k8s-home-lab/home-assistant -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/k8s-home-lab-helm-charts/home-assistant?modal=changelog)
