...
![Version: 9.1.1](https://img.shields.io/badge/Version-9.1.1-informational?style=flat-square) ![AppVersion: 0.6.26](https://img.shields.io/badge/AppVersion-0.6.26-informational?style=flat-square)
...
helm repo update
helm install calibre-web k8s-home-lab/calibre-web
```
...
helm install calibre-web \
  --set env.TZ="America/New York" \
    k8s-home-lab/calibre-web
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install calibre-web k8s-home-lab/calibre-web -f values.yaml
```
