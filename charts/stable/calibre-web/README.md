...
helm repo update
helm install calibre-web Aste88/calibre-web
```
...
```console
helm install calibre-web Aste88/calibre-web -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/calibre-web?modal=changelog)
