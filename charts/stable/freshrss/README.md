...
helm repo update
helm install freshrss k8s-home-lab/freshrss
```
...
helm install freshrss \
  --set env.TZ="America/New York" \
    k8s-home-lab/freshrss
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install freshrss k8s-home-lab/freshrss -f values.yaml
```
...
| image.repository | string | `"ghcr.io/linuxserver/freshrss"` | image repository |
