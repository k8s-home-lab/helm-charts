...
![Version: 11.0.0](https://img.shields.io/badge/Version-11.0.0-informational?style=flat-square) ![AppVersion: v0.28.2](https://img.shields.io/badge/AppVersion-v0.28.2-informational?style=flat-square)
...
helm repo update
helm install blocky k8s-home-lab/blocky
```
...
```console
helm install blocky k8s-home-lab/blocky -f values.yaml
```
