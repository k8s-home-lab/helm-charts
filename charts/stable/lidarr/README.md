...
helm repo update
helm install lidarr Aste88/lidarr
```
...
```console
helm install lidarr Aste88/lidarr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/lidarr?modal=changelog)
