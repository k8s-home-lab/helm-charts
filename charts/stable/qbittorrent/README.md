...
![Version: 14.0.1](https://img.shields.io/badge/Version-14.0.1-informational?style=flat-square) ![AppVersion: 4.5.0](https://img.shields.io/badge/AppVersion-4.5.0-informational?style=flat-square)
...
helm repo update
helm install qbittorrent Aste88/qbittorrent
```
...
```console
helm install qbittorrent Aste88/qbittorrent -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/qbittorrent?modal=changelog)
