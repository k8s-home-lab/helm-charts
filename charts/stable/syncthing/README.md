...
![Version: 5.1.0](https://img.shields.io/badge/Version-5.1.0-informational?style=flat-square) ![AppVersion: 2.0.14](https://img.shields.io/badge/AppVersion-2.0.14-informational?style=flat-square)
...
helm repo update
helm install syncthing k8s-home-lab/syncthing
```
...
helm install syncthing \
  --set env.TZ="America/New York" \
    k8s-home-lab/syncthing
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install syncthing k8s-home-lab/syncthing -f values.yaml
```
