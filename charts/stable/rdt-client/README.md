...
* <https://github.com/rdt-client/rdt-client-docker>
...
helm repo update
helm install rdt-client k8s-home-lab-helm-charts/rdt-client
```
...
helm install rdt-client \
  --set env.TZ="America/New York" \
    k8s-home-lab-helm-charts/rdt-client
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install rdt-client k8s-home-lab-helm-charts/rdt-client -f values.yaml
```
...
| image.repository | string | `"rdt-client/rdt-client"` | image repository |
