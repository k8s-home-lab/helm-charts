...
![Version: 12.1.0](https://img.shields.io/badge/Version-12.1.0-informational?style=flat-square) ![AppVersion: 2.16.0](https://img.shields.io/badge/AppVersion-2.16.0-informational?style=flat-square)
...
helm repo update
helm install tautulli k8s-home-lab/tautulli
```
...
helm install tautulli \
  --set env.TZ="America/New York" \
    k8s-home-lab/tautulli
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install tautulli k8s-home-lab/tautulli -f values.yaml
```
...
| image.repository | string | `"ghcr.io/home-operations/tautulli"` | image repository |
