...
![Version: 6.0.0](https://img.shields.io/badge/Version-6.0.0-informational?style=flat-square) ![AppVersion: v1.2.8](https://img.shields.io/badge/AppVersion-v1.2.8-informational?style=flat-square)
...
helm repo update
helm install flaresolverr Aste88/flaresolverr
```
...
```console
helm install flaresolverr Aste88/flaresolverr -f values.yaml
```
...
| image.tag | string | `"v3.2.0"` | image tag |
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/flaresolverr?modal=changelog)
