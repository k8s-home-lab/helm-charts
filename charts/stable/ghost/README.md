...
![Version: 3.1.0](https://img.shields.io/badge/Version-3.1.0-informational?style=flat-square) ![AppVersion: 5.51.1](https://img.shields.io/badge/AppVersion-5.51.1-informational?style=flat-square)
...
helm repo update
helm install ghost k8s-home-lab/ghost
```
...
```console
helm install ghost k8s-home-lab/ghost -f values.yaml
```
