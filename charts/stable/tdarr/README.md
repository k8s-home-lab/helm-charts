...
helm repo update
helm install tdarr Aste88/tdarr
```
...
```console
helm install tdarr Aste88/tdarr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/tdarr?modal=changelog)
