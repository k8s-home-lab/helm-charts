...
![Version: 5.1.0](https://img.shields.io/badge/Version-5.1.0-informational?style=flat-square) ![AppVersion: 2.11.01](https://img.shields.io/badge/AppVersion-2.11.01-informational?style=flat-square)
...
helm repo update
helm install tdarr k8s-home-lab/tdarr
```
...
```console
helm install tdarr k8s-home-lab/tdarr -f values.yaml
```
...
| node.image.tag | string | `"2.58.02@sha256:62e14509bc19dea9b6f5dc85d0942163b6fa240d780a53eb590d894d46c9e1f2"` | image tag |
