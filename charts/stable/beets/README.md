...
![Version: 3.1.0](https://img.shields.io/badge/Version-3.1.0-informational?style=flat-square) ![AppVersion: 2.3.1](https://img.shields.io/badge/AppVersion-2.3.1-informational?style=flat-square)
...
helm repo update
helm install beets k8s-home-lab/beets
```
...
```console
helm install beets k8s-home-lab/beets -f values.yaml
```
...
| image.repository | string | `"ghcr.io/home-operations/beets"` | image repository |
