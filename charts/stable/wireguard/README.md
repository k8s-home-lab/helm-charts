...
![Version: 1.6.0](https://img.shields.io/badge/Version-1.6.0-informational?style=flat-square) ![AppVersion: v1.0.20210914](https://img.shields.io/badge/AppVersion-v1.0.20210914-informational?style=flat-square)
...
helm repo update
helm install wireguard k8s-home-lab/wireguard
```
...
helm install wireguard \
  --set env.TZ="America/New York" \
    k8s-home-lab/wireguard
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install wireguard k8s-home-lab/wireguard -f values.yaml
```
...
|-----|------|---------|-------------|
| configSecret | object | base64 encoded wg0.conf by running `base64 wg0.conf` | Otherwise you have to mount a volume to /etc/wireguard containing the wg0.conf. |
...
| image.repository | string | `"ghcr.io/k8s-home-lab/wireguard"` | image repository |
