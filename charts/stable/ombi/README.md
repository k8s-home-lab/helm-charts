...
![Version: 12.2.1](https://img.shields.io/badge/Version-12.2.1-informational?style=flat-square) ![AppVersion: 4.53.5](https://img.shields.io/badge/AppVersion-4.53.5-informational?style=flat-square)
...
helm repo update
helm install ombi k8s-home-lab/ombi
```
...
```console
helm install ombi k8s-home-lab/ombi -f values.yaml
```
...
| env.PGID | string | `"65534"` | Specify the group ID the application will run as |
| env.PUID | string | `"65534"` | Specify the user ID the application will run as |
