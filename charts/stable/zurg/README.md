...
* <https://github.com/zurg/zurg-docker>
...
helm repo update
helm install zurg k8s-home-lab-helm-charts/zurg
```
...
helm install zurg \
  --set env.TZ="America/New York" \
    k8s-home-lab-helm-charts/zurg
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install zurg k8s-home-lab-helm-charts/zurg -f values.yaml
```
...
| image.repository | string | `"zurg/zurg"` | image repository |
