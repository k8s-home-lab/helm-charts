...
helm repo update
helm install readarr Aste88/readarr
```
...
```console
helm install readarr Aste88/readarr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/readarr?modal=changelog)
