...
helm repo update
helm install bazarr Aste88/bazarr
```
...
```console
helm install bazarr Aste88/bazarr -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/aste88-helm-charts/bazarr?modal=changelog)
