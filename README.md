...
[![Artifact Hub](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/k8s-home-lab-helm-charts&style=for-the-badge)](https://artifacthub.io/packages/search?repo=k8s-home-lab-helm-charts)
...
```console
helm repo add k8s-home-lab-helm-charts https://k8s-home-lab.github.io/helm-charts/
```
