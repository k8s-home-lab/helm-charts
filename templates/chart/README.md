...
|------------|------|---------|
| https://k8s-home-lab.github.io/helm-charts/ | common | 4.5.4 |
...
helm repo update
helm install ${CHARTNAME} k8s-home-lab-helm-charts/${CHARTNAME}
```
...
helm install ${CHARTNAME} \
  --set env.TZ="America/New York" \
    k8s-home-lab-helm-charts/${CHARTNAME}
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install ${CHARTNAME} k8s-home-lab-helm-charts/${CHARTNAME} -f values.yaml
```
